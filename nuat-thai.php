...
<body>
 ...
 <section class="header-navi-space bg-light-navigator">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <small><a href="index.php" class="text-lighted">Home</a></small> <span class="icon-keyboard_arrow_right"></span> <small class="text-lighted">Nuat Thai</small>
      </div>                                                             
    </div>
  </div>
</section>
    ...
    <div class="row">
      <div class="col-md-8">
        <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
          ...
          <h2>Nuat Thai</h2>
          <p class="rate mb-5">
            <span class="loc"><i class="icon-map"></i> Alona Beach Rd, Panglao Island, 6340 Bohol (near Lost Horizon Resort) <span class="icon-long-arrow-right"></span> <a class="map-link" href="https://www.google.com/maps/place/Lost+Horizon+Resort/@9.5481019,123.7713346,19z/data=!4m16!1m7!3m6!1s0x33abac9f32e574a7:0x48e7cb35746858e1!2sAlona+Beach!3b1!8m2!3d9.5485549!4d123.7740322!3m7!1s0x0:0x9f2292d63c64141c!5m2!4m1!1i2!8m2!3d9.5481537!4d123.7711851" target="_blank">Show map</a></span>                           
          </p>          
          <div class="single-slider owl-carousel space-bottom-high">    
            <div class="item">
              <div class="hotel-img" style="background-image: url('images/nuat-thai/nuat-thai-02.jpg');"></div>
            </div>            
            <div class="item">
              <div class="hotel-img" style="background-image: url('images/nuat-thai/nuat-thai-01.jpg');"></div>
            </div>                                                            
            <div class="item">
              <div class="hotel-img" style="background-image: url('images/nuat-thai/nuat-thai-03.jpg');"></div>
            </div>                                            
          </div>                    
          <p>We're open everyday from 10am to 12am.</p>         
          <!-- <div class="ftco-animate space-top-high">
            <h2><i class="icon-restaurant_menu orange"></i> Precitos Restaurant Menu</h2>
            <div class="row">
              <a href="images/kingstown/kingstown-01.png" data-lightbox="products" title="Menu 1"><img src="images/kingstown/kingstown-01.png" class="menu-img"></a>
              <a href="images/kingstown/kingstown-02.png" data-lightbox="products" title="Menu 2"><img src="images/kingstown/kingstown-02.png" class="menu-img"></a>
              <a href="images/kingstown/kingstown-03.png" data-lightbox="products" title="Menu 3"><img src="images/kingstown/kingstown-03.png" class="menu-img"></a>
              <a href="images/kingstown/kingstown-04.png" data-lightbox="products" title="Menu 4"><img src="images/kingstown/kingstown-04.png" class="menu-img"></a>                          
            </div>            
          </div> -->                  
        </div>
      </div>
