    ...
    <div class="row">
      <div class="col-md-3 ftco-animate">
        ...
        <div class="auto-height" >          
          ...
          <ul class="rates">
            ...
            <li class="active"><a href="accommodation-rates.php" class="black"> Accommodation Rates</a></li>
      ...
      <div class="col-md-9 hotel-single ftco-animate">
        <div class="col-md-12 bg-green">
          <span class="text-lighted">Accommodation Rates</span>
        </div>
        <?php                  

        $get_hotel_rooms_stmt = $mysqli->prepare( "SELECT * FROM hotel" );        
            ...
            <div class="container">   
              <div class="col-md-12 space-bottom bg-white padding-vertical">  
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-8">
                      <p><span class="text-lighted"><?php echo $hotelDisplayName; ?></span></p>
                        <small><i class="icon-map orange"></i> <?php echo $hotel['hotel-address'];?></small>
                      </div>
                      <div class="col-md-4">
                        <a href="accommodation.php?p=<?php echo $slug;?>"><input type="submit" name="book-now" value="BOOK NOW" class="btn btn-secondary"></a>                                            
                    </div>                      
                    </div>
                  </div>   
                  <div class="table">                                   
                    <table class="rate">
                      <thead class="rate-header">
                        <tr>                                                                                  
                          ...
                          <th class="rate-th-no-last">Rate per Night</th>                          
                        </tr>
                      </thead>
                      <tbody class="rate-tbody">

                        <?php
                        $get_hotel_rooms_stmt2 = $mysqli->prepare( "SELECT * FROM hotel_rooms WHERE hotel_ID = $hotel_id" );        
                        $get_hotel_rooms_stmt2->execute();
                        $get_hotel_rooms_result2 = $get_hotel_rooms_stmt2->get_result();                            

                        if( $get_hotel_rooms_result2->num_rows > 0 ) :
                          while( $row = $get_hotel_rooms_result2->fetch_assoc() ) : 
                            ...
                            <tr class="rates">                              
                              <td class="rates-td">
                                <?php echo $rate['room-type'];?>

                              </td>
                              <td class="rates-td"><span class="text-lighted">&#8369; <?php echo number_format( $rate['rate'], 2);?></span></td>                              
                            </tr> 
                            <?php 
                          endwhile;              
                        endif; 
                        $get_hotel_rooms_stmt2->close();                       
                        ?>
