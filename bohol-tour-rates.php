    ...
    <div class="row">
      <div class="col-md-3 ftco-animate">
        ...
        <div class="auto-height" >          
          ...
          <ul class="rates">
            ...
            <li class="active"><a href="bohol-tour-rates.php" class="black"> Bohol Tour Rates</a></li> 
      ...
      <div class="col-md-9 hotel-single ftco-animate">
        <div class="col-md-12 bg-green">
          <span class="text-lighted">Bohol Tour Rates</span>          
        </div>
        <?php
              ...
              <div class="col-md-12 space-bottom bg-white padding-vertical">  
                <div class="form-group">
                  <div class="row">
                    ...
                    <div class="col-md-4">
                        <a href="bohol-tours.php?p=<?php echo $slug;?>"><input type="submit" name="book-now" value="BOOK NOW" class="btn btn-secondary"></a>                                            
                    </div>                    
                  </div>
                </div>   
                <div class="table">                                   
